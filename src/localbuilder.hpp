#ifndef SRC_LOCALBUILDER_HPP_
#define SRC_LOCALBUILDER_HPP_
...
class LocalBuilder {
 private:
  ...
  const vector<double> gaussWeights = {0.111690794839, 0.111690794839,
                                       0.111690794839, 0.054975871827,
                                       0.054975871827, 0.054975871827};
